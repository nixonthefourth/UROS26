...
namespace physics {
    ...
    Vec2 find_g_acceleration(double m_a, double distance, const Vec2& a, const Vec2& b, double G);
    ...
    double find_velocity(double m, double distance, double G);
    ...
    double find_energy_conservation(double M, double m, double G, double distance, const Vec2& b_velocity);
