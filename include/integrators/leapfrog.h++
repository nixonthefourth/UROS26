...
namespace leapfrog {
    ...
    Vec2 half_velocity_update(const Vec2& velocity, const Vec2& acceleration, double t);
    ...
    Vec2 position_update(const Vec2& position, const Vec2& half_velocity, double t);
    ...
    Vec2 velocity_update(const Vec2& half_velocity, const Vec2& acceleration, double t);
